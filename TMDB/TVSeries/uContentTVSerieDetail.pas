...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, uContentBase, uTMDBContentBase, Vcl.ComCtrls, JD.Common,
...
type
  TfrmContentTVSerieDetail = class(TfrmTMDBContentBase)
    Pages: TPageControl;
    TabSheet1: TTabSheet;
    TabSheet2: TTabSheet;
    TabSheet3: TTabSheet;
...
begin
  ...
  Result:= TMDB.Client.TVSeries.GetDetails(ID, Inc, TMDBSetup.Language,
