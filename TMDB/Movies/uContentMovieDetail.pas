...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, uContentBase, uTMDBContentBase, Vcl.ComCtrls,
  Vcl.StdCtrls,
  Vcl.ExtCtrls,
  PngImage,
  Jpeg,
...
type
  TfrmContentMovieDetail = class(TfrmTMDBContentBase)
    Pages: TPageControl;
    TabSheet1: TTabSheet;
    txtOverview: TMemo;
    TabSheet2: TTabSheet;
  ...
  private
    ...
    function EmbedFormIntoTab(AClass: TfrmTMDBCommonFormBaseClass;
      ATab: TTabSheet): TfrmTMDBCommonFormBase; overload;
    function EmbedFormIntoTab(AClass: TfrmTMDBContentBaseClass;
      ATab: TTabSheet): TfrmTMDBContentBase; overload;
...
begin
  ...
  Result:= TMDB.Client.Movies.GetDetails(ID, Inc, TMDBSetup.Language,
...
begin
  if FSimilar.OnGetPage = nil then begin
    ...
    FSimilar.OnGetPage:=
      ...
      begin
        Data:= TMDB.Movies.GetSimilar(ID, TMDBSetup.Language, Page);
      end;
  end;
