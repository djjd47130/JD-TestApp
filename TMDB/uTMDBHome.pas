...
uses
  ...
  Vcl.StdCtrls, uTMDBListItem, uTMDBMovieListItem, uTMDBVertMovieListItem, Vcl.Imaging.pngimage, JD.ListController;
...
type
  TfrmTMDBHome = class(TfrmTMDBContentBase)
    ...
    tmrLoadDelay: TTimer;
    lstTopRatedMovies: TJDListController;
...
begin
  ...
  if not Configured then begin
    ...
    case MessageDlg('TMDB API must be properly configured to continue.'+
      ...
      mrYes: begin
        //var Tab:=
          TfrmAppWindow(MainForm).TabController.CreateTab(TfrmTMDBSetup);
      end;
      else begin
...
begin
  ...
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentDiscoverMovies);
  //HideMenu;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentCertsMovies);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentChangesMovies);
  //HideMenu;
end;
...
begin
  inherited;
  T:= TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentTVPage);
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentCertsTV);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentConfigCountries);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentConfigJobs);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).OpenNewBrowserTab('https://www.themoviedb.org/');
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentConfigLanguages);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentConfigTimezones);
  //HideMenu;
end;
...
begin
  inherited;
  T:= TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentMoviePage);
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmTMDBSearch);
end;

procedure TfrmTMDBHome.btnMovieGenresClick(Sender: TObject);
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentGenresMovie);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentGenresTV);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentSearchCollections);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentSearchTV);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentSearchCompanies);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentSearchKeywords);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentSearchMovies);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentSearchMulti);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmContentSearchPeople);
  //HideMenu;
end;
...
begin
  inherited;
  TfrmAppWindow(MainForm).TabController.CreateTab(TfrmTMDBSetup, -1, 0);
  //HideMenu;
end;
...
procedure TfrmTMDBHome.LoadTopRatedMovies;
var
  F: TfrmTMDBVertMovieListItem;
begin

  sbTopRatedMovies.DisableAlign;
  try

    //Delete all items...
    while sbTopRatedMovies.ControlCount > 0 do begin
      sbTopRatedMovies.Controls[0].Free;
    end;
    ...
    for var X := 0 to Data.Items.Count-1 do begin
      var I:= Data.Items[X];
      F:= TfrmTMDBVertMovieListItem.Create(sbTopRatedMovies);
      F.Name:= 'frmTrendingMovie'+IntToStr(X);
      F.Width:= 200;
      F.Align:= alLeft;
      F.LoadItem(I);
      F.Parent:= sbTopRatedMovies;
    end;

  finally
    sbTopRatedMovies.EnableAlign;
  end;
